  ...
  $.ui.define('slider', {
      ...
      (me.root() || me.root($('<div></div>'))).addClass('ui-slider').appendTo(me.data('container') || (me.root().parent().length ? '' : document.body)).html(
        ...
        (function() {
          if(me.data('itemRender')) {
            ...
            while(j = content[i++]) k.push('<div style="position: relative;" class="ui-slider-item"><img style="display:block;position: absolute;left: 0;top:50%; transform: translate(0, -50%);" lazyload="' + j.pic + '"/>'  + '</div>');
          }
    ...
    _setWidth:function(){
      var me = this,
        o = me._data,
        root = me.root(),
        width = Math.ceil(window.innerWidth / o.viewNum),
